...
-- ============================================================
-- INDIA — Tier 1 City Top Colleges (Top 20 per city)
-- ============================================================

-- MUMBAI
('University of Mumbai', 'MU', 'mu.ac.in', 'India', 'IND', 'Maharashtra', 'Mumbai', 'top_public', 'public', TRUE),
('Institute of Chemical Technology', 'ICT Mumbai', 'ictmumbai.edu.in', 'India', 'IND', 'Maharashtra', 'Mumbai', 'top_public', 'public', TRUE),
('Tata Institute of Social Sciences', 'TISS', 'tiss.edu', 'India', 'IND', 'Maharashtra', 'Mumbai', 'top_public', 'public', TRUE),
('Tata Institute of Fundamental Research', 'TIFR', 'tifr.res.in', 'India', 'IND', 'Maharashtra', 'Mumbai', 'top_public', 'public', TRUE),
('St. Xavier''s College Mumbai', 'Xavier''s Mumbai', 'xaviers.edu', 'India', 'IND', 'Maharashtra', 'Mumbai', 'top_private', 'private', TRUE),
('Narsee Monjee Institute of Management', 'NMIMS', 'nmims.edu', 'India', 'IND', 'Maharashtra', 'Mumbai', 'top_private', 'private', TRUE),
('K.J. Somaiya College of Engineering', 'KJSCE', 'kjsce.somaiya.edu', 'India', 'IND', 'Maharashtra', 'Mumbai', 'top_private', 'private', TRUE),
('Dwarkadas J. Sanghvi College of Engineering', 'DJSCE', 'djsce.ac.in', 'India', 'IND', 'Maharashtra', 'Mumbai', 'top_private', 'private', TRUE),
('Fr. Conceicao Rodrigues College of Engineering', 'FRCRCE', 'frcrce.ac.in', 'India', 'IND', 'Maharashtra', 'Mumbai', 'top_private', 'private', TRUE),
('Thadomal Shahani Engineering College', 'TSEC', 'tsec.edu', 'India', 'IND', 'Maharashtra', 'Mumbai', 'top_private', 'private', TRUE),
('Rizvi College of Engineering', 'Rizvi', 'rizvi.edu.in', 'India', 'IND', 'Maharashtra', 'Mumbai', 'regular', 'private', TRUE),
('Shah and Anchor Kutchhi Engineering College', 'SAKEC', 'sakec.ac.in', 'India', 'IND', 'Maharashtra', 'Mumbai', 'regular', 'private', TRUE),
('Atharva College of Engineering', 'Atharva', 'atharvaengineering.com', 'India', 'IND', 'Maharashtra', 'Mumbai', 'regular', 'private', TRUE),
('Vidyalankar Institute of Technology', 'VIT Mumbai', 'vit.edu.in', 'India', 'IND', 'Maharashtra', 'Mumbai', 'regular', 'private', TRUE),
('SIES Graduate School of Technology', 'SIES GST', 'siesgst.ac.in', 'India', 'IND', 'Maharashtra', 'Mumbai', 'regular', 'private', TRUE),

-- DELHI / NCR
('University of Delhi', 'DU', 'du.ac.in', 'India', 'IND', 'Delhi', 'Delhi', 'top_public', 'public', TRUE),
('Indian Institute of Technology Delhi', 'IIT Delhi', 'iitd.ac.in', 'India', 'IND', 'Delhi', 'Delhi', 'top_public', 'public', TRUE),
('Jawaharlal Nehru University', 'JNU', 'jnu.ac.in', 'India', 'IND', 'Delhi', 'Delhi', 'top_public', 'public', TRUE),
('Indian Institute of Management Delhi', 'IIM Delhi', 'iimdelhi.ac.in', 'India', 'IND', 'Delhi', 'Delhi', 'top_public', 'public', TRUE),
('Ambedkar Institute of Advanced Communication Technologies', 'AIACTR', 'aiactr.ac.in', 'India', 'IND', 'Delhi', 'Delhi', 'top_public', 'public', TRUE),
('Lady Shri Ram College', 'LSR', 'lsr.edu.in', 'India', 'IND', 'Delhi', 'Delhi', 'top_public', 'public', TRUE),
('Miranda House', 'Miranda', 'mirandahouse.ac.in', 'India', 'IND', 'Delhi', 'Delhi', 'top_public', 'public', TRUE),
('Hindu College Delhi', 'Hindu College', 'hinducollege.ac.in', 'India', 'IND', 'Delhi', 'Delhi', 'top_public', 'public', TRUE),
('St. Stephen''s College Delhi', 'St. Stephen''s', 'ststephens.edu', 'India', 'IND', 'Delhi', 'Delhi', 'top_private', 'private', TRUE),
('Shaheed Sukhdev College of Business Studies', 'SSCBS', 'sscbsdu.ac.in', 'India', 'IND', 'Delhi', 'Delhi', 'top_public', 'public', TRUE),
('Kirori Mal College', 'KMC Delhi', 'kmc.du.ac.in', 'India', 'IND', 'Delhi', 'Delhi', 'top_public', 'public', TRUE),
('Bhagini Nivedita College', 'BNC', 'bncdu.ac.in', 'India', 'IND', 'Delhi', 'Delhi', 'regular', 'public', TRUE),
('Vivekananda Institute of Professional Studies', 'VIPS', 'vips.edu', 'India', 'IND', 'Delhi', 'Delhi', 'top_private', 'private', TRUE),
('Maharaja Agrasen Institute of Technology', 'MAIT', 'mait.ac.in', 'India', 'IND', 'Delhi', 'Delhi', 'top_private', 'private', TRUE),
('Bharat Institute of Technology', 'BIT Delhi', 'bitdelhi.ac.in', 'India', 'IND', 'Delhi', 'Delhi', 'regular', 'private', TRUE),
-- NCR
('Jaypee Institute of Information Technology', 'JIIT', 'jiit.ac.in', 'India', 'IND', 'Uttar Pradesh', 'Noida', 'top_private', 'private', TRUE),
('Amity University Noida', 'Amity Noida', 'amity.edu', 'India', 'IND', 'Uttar Pradesh', 'Noida', 'top_private', 'private', TRUE),
('KIET Group of Institutions', 'KIET', 'kiet.edu', 'India', 'IND', 'Uttar Pradesh', 'Ghaziabad', 'regular', 'private', TRUE),
('Manav Rachna International Institute', 'MRIIRS', 'mriu.edu.in', 'India', 'IND', 'Haryana', 'Faridabad', 'top_private', 'private', TRUE),
('The NorthCap University', 'NCU', 'ncuindia.edu', 'India', 'IND', 'Haryana', 'Gurugram', 'top_private', 'private', TRUE),
('SRM University Delhi-NCR', 'SRM NCR', 'srmuniversity.ac.in', 'India', 'IND', 'Haryana', 'Sonepat', 'regular', 'private', TRUE),

-- BENGALURU
('Indian Institute of Science', 'IISc', 'iisc.ac.in', 'India', 'IND', 'Karnataka', 'Bengaluru', 'top_public', 'public', TRUE),
('Indian Institute of Management Bangalore', 'IIMB', 'iimb.ac.in', 'India', 'IND', 'Karnataka', 'Bengaluru', 'top_public', 'public', TRUE),
('Indian Institute of Technology Bangalore', 'IIT Bangalore', 'iitb.ac.in', 'India', 'IND', 'Karnataka', 'Bengaluru', 'top_public', 'public', TRUE),
('National Institute of Fashion Technology Bengaluru', 'NIFT Bengaluru', 'nift.ac.in', 'India', 'IND', 'Karnataka', 'Bengaluru', 'top_public', 'public', TRUE),
('Bangalore Institute of Technology', 'BIT Bangalore', 'bit-bangalore.edu.in', 'India', 'IND', 'Karnataka', 'Bengaluru', 'top_private', 'private', TRUE),
('JSS Academy of Technical Education', 'JSSATE', 'jssateb.ac.in', 'India', 'IND', 'Karnataka', 'Bengaluru', 'top_private', 'private', TRUE),
('Ramaiah Institute of Technology', 'RIT Bangalore', 'msrit.edu', 'India', 'IND', 'Karnataka', 'Bengaluru', 'top_private', 'private', TRUE),
('Nitte Meenakshi Institute of Technology', 'NMIT', 'nmit.ac.in', 'India', 'IND', 'Karnataka', 'Bengaluru', 'top_private', 'private', TRUE),
('Christ University', 'Christ', 'christuniversity.in', 'India', 'IND', 'Karnataka', 'Bengaluru', 'top_private', 'private', TRUE),
('Presidency University Bengaluru', 'Presidency', 'presidencyuniversity.in', 'India', 'IND', 'Karnataka', 'Bengaluru', 'regular', 'private', TRUE),
('CMR Institute of Technology', 'CMRIT', 'cmrit.ac.in', 'India', 'IND', 'Karnataka', 'Bengaluru', 'regular', 'private', TRUE),
('Sir M Visvesvaraya Institute of Technology', 'Sir MVIT', 'sirmvit.edu', 'India', 'IND', 'Karnataka', 'Bengaluru', 'top_private', 'private', TRUE),
('East Point College of Engineering', 'EPCE', 'eastpoint.ac.in', 'India', 'IND', 'Karnataka', 'Bengaluru', 'regular', 'private', TRUE),
('Vemana Institute of Technology', 'VIT Bengaluru', 'vemana.org', 'India', 'IND', 'Karnataka', 'Bengaluru', 'regular', 'private', TRUE),

-- CHENNAI
('Indian Institute of Management Chennai', 'IIM Chennai', 'iimchennai.ac.in', 'India', 'IND', 'Tamil Nadu', 'Chennai', 'top_public', 'public', TRUE),
('National Institute of Technology Tiruchirappalli', 'NIT Trichy', 'nitt.edu', 'India', 'IND', 'Tamil Nadu', 'Chennai', 'top_public', 'public', TRUE),
('Loyola College Chennai', 'Loyola', 'loyolachennai.edu.in', 'India', 'IND', 'Tamil Nadu', 'Chennai', 'top_private', 'private', TRUE),
('Madras Christian College', 'MCC', 'mcc.edu.in', 'India', 'IND', 'Tamil Nadu', 'Chennai', 'top_private', 'private', TRUE),
('Sathyabama Institute of Science and Technology', 'Sathyabama', 'sathyabama.ac.in', 'India', 'IND', 'Tamil Nadu', 'Chennai', 'top_private', 'private', TRUE),
('Saveetha Institute of Medical and Technical Sciences', 'Saveetha', 'saveetha.com', 'India', 'IND', 'Tamil Nadu', 'Chennai', 'top_private', 'private', TRUE),
('Velammal Engineering College', 'Velammal', 'velammal.edu.in', 'India', 'IND', 'Tamil Nadu', 'Chennai', 'top_private', 'private', TRUE),
('St. Joseph''s College of Engineering', 'SJCE Chennai', 'stjosephs.ac.in', 'India', 'IND', 'Tamil Nadu', 'Chennai', 'top_private', 'private', TRUE),
('Rajalakshmi Engineering College', 'REC Chennai', 'rajalakshmi.edu.in', 'India', 'IND', 'Tamil Nadu', 'Chennai', 'regular', 'private', TRUE),
('Easwari Engineering College', 'EEC', 'easwari.ac.in', 'India', 'IND', 'Tamil Nadu', 'Chennai', 'regular', 'private', TRUE),
('Jeppiaar Engineering College', 'JEC', 'jeppiaarengcollege.ac.in', 'India', 'IND', 'Tamil Nadu', 'Chennai', 'regular', 'private', TRUE),
('Sri Sairam Engineering College', 'Sri Sairam', 'sairam.edu.in', 'India', 'IND', 'Tamil Nadu', 'Chennai', 'regular', 'private', TRUE),
('Panimalar Engineering College', 'Panimalar', 'panimalar.ac.in', 'India', 'IND', 'Tamil Nadu', 'Chennai', 'regular', 'private', TRUE),
('Misrimal Navajee Munoth Jain Engineering College', 'JEPPIAAR', 'mjcollege.ac.in', 'India', 'IND', 'Tamil Nadu', 'Chennai', 'regular', 'private', TRUE),

-- HYDERABAD
('Indian Institute of Management Hyderabad', 'IIM Hyderabad', 'iimhyd.ac.in', 'India', 'IND', 'Telangana', 'Hyderabad', 'top_public', 'public', TRUE),
...
('Anurag University', 'Anurag', 'anurag.edu.in', 'India', 'IND', 'Telangana', 'Hyderabad', 'regular', 'private', TRUE),
('Vardhaman College of Engineering', 'VCE Hyderabad', 'vardhaman.org', 'India', 'IND', 'Telangana', 'Hyderabad', 'regular', 'private', TRUE),
('VNR Vignana Jyothi Institute of Engineering', 'VNRVJIET', 'vnrvjiet.ac.in', 'India', 'IND', 'Telangana', 'Hyderabad', 'top_private', 'private', TRUE),
('CMR College of Engineering and Technology', 'CMRCET', 'cmrcet.ac.in', 'India', 'IND', 'Telangana', 'Hyderabad', 'regular', 'private', TRUE),

-- KOLKATA
('Presidency University Kolkata', 'Presidency Kolkata', 'presiuniv.ac.in', 'India', 'IND', 'West Bengal', 'Kolkata', 'top_public', 'public', TRUE),
('University of Calcutta', 'CU Kolkata', 'caluniv.ac.in', 'India', 'IND', 'West Bengal', 'Kolkata', 'top_public', 'public', TRUE),
('Indian Institute of Management Calcutta', 'IIMC', 'iimcal.ac.in', 'India', 'IND', 'West Bengal', 'Kolkata', 'top_public', 'public', TRUE),
('St. Xavier''s College Kolkata', 'Xavier''s Kolkata', 'sxccal.edu', 'India', 'IND', 'West Bengal', 'Kolkata', 'top_private', 'private', TRUE),
('Techno Main Salt Lake', 'TMSL', 'technomain.edu.in', 'India', 'IND', 'West Bengal', 'Kolkata', 'top_private', 'private', TRUE),
('Institute of Engineering and Management', 'IEM Kolkata', 'iem.edu.in', 'India', 'IND', 'West Bengal', 'Kolkata', 'top_private', 'private', TRUE),
('Calcutta Institute of Engineering and Management', 'CIEM', 'ciem.edu.in', 'India', 'IND', 'West Bengal', 'Kolkata', 'regular', 'private', TRUE),
('Guru Nanak Institute of Technology', 'GNIT', 'gnit.ac.in', 'India', 'IND', 'West Bengal', 'Kolkata', 'regular', 'private', TRUE),
('Meghnad Saha Institute of Technology', 'MSIT', 'msit.edu.in', 'India', 'IND', 'West Bengal', 'Kolkata', 'regular', 'private', TRUE),
('Bengal Institute of Technology', 'BIT Kolkata', 'bit.ac.in', 'India', 'IND', 'West Bengal', 'Kolkata', 'regular', 'private', TRUE),
('RCC Institute of Information Technology', 'RCCIIT', 'rcciit.in', 'India', 'IND', 'West Bengal', 'Kolkata', 'regular', 'private', TRUE),

-- PUNE
('Indian Institute of Management Pune', 'IIM Pune', 'iimpune.ac.in', 'India', 'IND', 'Maharashtra', 'Pune', 'top_public', 'public', TRUE),
('National Defence Academy', 'NDA', 'nda.nic.in', 'India', 'IND', 'Maharashtra', 'Pune', 'top_public', 'public', TRUE),
('Armed Forces Medical College', 'AFMC', 'afmc.nic.in', 'India', 'IND', 'Maharashtra', 'Pune', 'top_public', 'public', TRUE),
('Fergusson College', 'FC Pune', 'fergusson.edu', 'India', 'IND', 'Maharashtra', 'Pune', 'top_public', 'public', TRUE),
('Bharati Vidyapeeth College of Engineering', 'BVCE', 'bvucoep.edu.in', 'India', 'IND', 'Maharashtra', 'Pune', 'top_private', 'private', TRUE),
('Sinhgad College of Engineering', 'SCOE', 'sinhgad.edu', 'India', 'IND', 'Maharashtra', 'Pune', 'top_private', 'private', TRUE),
('D.Y. Patil College of Engineering', 'DYPCOE', 'dypce.ac.in', 'India', 'IND', 'Maharashtra', 'Pune', 'top_private', 'private', TRUE),
('Zeal College of Engineering', 'Zeal', 'zealeducation.com', 'India', 'IND', 'Maharashtra', 'Pune', 'regular', 'private', TRUE),
('Indira College of Engineering and Management', 'ICEM', 'icemkjei.com', 'India', 'IND', 'Maharashtra', 'Pune', 'regular', 'private', TRUE),
('Pimpri Chinchwad College of Engineering', 'PCCOE', 'pccoepune.org', 'India', 'IND', 'Maharashtra', 'Pune', 'top_private', 'private', TRUE),
('NBN Sinhgad School of Engineering', 'NBNSSOE', 'nbnssoe.ac.in', 'India', 'IND', 'Maharashtra', 'Pune', 'regular', 'private', TRUE),

-- AHMEDABAD
('Indian Institute of Technology Gandhinagar', 'IIT GN', 'iitgn.ac.in', 'India', 'IND', 'Gujarat', 'Ahmedabad', 'top_public', 'public', TRUE),
('Gujarat University', 'GU', 'gujaratuniversity.ac.in', 'India', 'IND', 'Gujarat', 'Ahmedabad', 'top_public', 'public', TRUE),
('CEPT University', 'CEPT', 'cept.ac.in', 'India', 'IND', 'Gujarat', 'Ahmedabad', 'top_public', 'public', TRUE),
('National Institute of Design Ahmedabad', 'NID', 'nid.edu', 'India', 'IND', 'Gujarat', 'Ahmedabad', 'top_public', 'public', TRUE),
('Dhirubhai Ambani Institute of ICT', 'DA-IICT', 'daiict.ac.in', 'India', 'IND', 'Gujarat', 'Ahmedabad', 'top_private', 'private', TRUE),
('Adani Institute of Infrastructure Engineering', 'AIIE', 'aiie.ac.in', 'India', 'IND', 'Gujarat', 'Ahmedabad', 'top_private', 'private', TRUE),
('Ahmedabad University', 'AU', 'ahduni.edu.in', 'India', 'IND', 'Gujarat', 'Ahmedabad', 'top_private', 'private', TRUE),
('PDPU School of Technology', 'PDPU', 'pdpu.ac.in', 'India', 'IND', 'Gujarat', 'Gandhinagar', 'top_public', 'public', TRUE),
